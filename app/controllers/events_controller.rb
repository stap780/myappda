...
# POST /events
  ...
  private
    ...
    def event_params
      params.require(:event).permit(:custom_status, :financial_status, :casetype, event_actions_attributes: [:id, :channel, :event_id, :template_id, :pause, :pause_time, :timetable, :timetable_time, :operation])
    end
end
