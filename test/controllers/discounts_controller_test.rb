...
class DiscountsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discount" do
    assert_difference("Discount.count") do
      post discounts_url, params: { discount: { position: @discount.position, rule: @discount.rule, value: @discount.value } }
    end
  ...
  test "should update discount" do
    patch discount_url(@discount), params: { discount: { position: @discount.position, rule: @discount.rule, value: @discount.value } }
