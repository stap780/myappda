...
class CasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create case" do
    assert_difference('Case.count') do
      post cases_url, params: { case: { casetype: @case.casetype, client_id: @case.client_id, number: @case.number } }
    end
  ...
  test "should update case" do
    patch case_url(@case), params: { case: { casetype: @case.casetype, client_id: @case.client_id, number: @case.number } }
