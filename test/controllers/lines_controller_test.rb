...
class LinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create line" do
    assert_difference('Line.count') do
      post lines_url, params: { line: { price: @line.price, product_id: @line.product_id, quantity: @line.quantity, variant_id: @line.variant_id } }
    end
  ...
  test "should update line" do
    patch line_url(@line), params: { line: { price: @line.price, product_id: @line.product_id, quantity: @line.quantity, variant_id: @line.variant_id } }
